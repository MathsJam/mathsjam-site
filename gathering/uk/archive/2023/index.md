...
The list of [Saturday Night Table activities]({{site.url}}/gathering/uk/archive/2022/tables) from the 2023 gathering can be found here.
...
- [Alyssa's slides (online)](https://docs.google.com/presentation/d/1S2FeYJ5bGxnOXGZT7vQTkqOZqPL9m-ju2-weEP86E3w/edit?usp=sharing)
...
- [Website of Jaermuseet, Norway](https://www.jaermuseet.no/en/)
...
- [Sam's slides (PPT)]({{site.url}}/assets/talks/2023/SamHartburn-Tentothetopbutninetothewhat.pptx)
- [Sam's slides (PDF)]({{site.url}}/assets/talks/2023/SamHartburn-Tentothetopbutninetothewhat.pdf)
...
- [Google Teachable Machine (used in the demo)](https://teachablemachine.withgoogle.com/)
...
- [Ben's slides (PDF)]({{site.url}}/assets/talks/2023/BenAshforth-RoadTrip.pdf)
- [Video of Ben's talk](https://www.youtube.com/watch?v=MwRbr-MjwII)
...
- [Phil's slides (PPT)]({{site.url}}/assets/talks/2023/PhilRamsden-SliderulesIITheKolmogorovConnection.pptx)
- [Phil's slides (PDF)]({{site.url}}/assets/talks/2023/PhilRamsden-SliderulesIITheKolmogorovConnection.pdf)
...
- [Daniel's slides (online)](https://docs.google.com/presentation/d/1oZmZ4-4Em9WAjzFyUINQmIeoo_FpxrDbFk95pL_UI80/edit?usp=sharing)
...
- [Tarim's slides (HTML)]({{site.url}}/assets/talks/2023/Tarim-IllogicalSongLyrics.html)
...
OK, it's fine in the maths but has anyone ever tried to do the experiment for real?  Does it work?  Well, it does!  Here is a [video of an experiment done on an air-hockey table](https://www3.eng.cam.ac.uk/~hemh1/photos/12_collision_pi.mp4). The mass ratio I have used here is 16:1 so that the number of collisions should be sqrt(16) × π which is exactly right - we observe 12 collisions! 
...
- [Donald's slides (PPT)]({{site.url}}/assets/talks/2023/DonaldBell-RectanglingSquaresandRectangles.pptx)
...
- [David's slides (PPT)]({{site.url}}/assets/talks/2023/DaveHartburn-HowtoAvoidZombies.pptx)
- [David's slides (PDF)]({{site.url}}/assets/talks/2023/DaveHartburn-HowtoAvoidZombies.pdf)
...
- [Tom's slides (online)](https://docs.google.com/presentation/d/17eKQygwPgqr7KCph1vSn88GXRkKJrkw5wf-UNTF4_ZQ/edit#slide=id.p)
...
- [Matt's slides (PDF)]({{site.url}}/assets/talks/2023/MattParker-CalculatingPiByHand.pdf)
...
- [Bob's slides (ODP)]({{site.url}}/assets/talks/2023/BobHuxley-WhenisPiDayonMars.odp)
...
- [John's slides (PPT)]({{site.url}}/assets/talks/2023/JohnHoskinson-Diffyn-Gons.pptx)
- [John's slides (PDF)]({{site.url}}/assets/talks/2023/JohnHoskinson-Diffyn-Gons.pdf)
...
- [Alex's slides (PPT)]({{site.url}}/assets/talks/2023/AlexArthur-OnmorninginasleepyGermanvillage.pptx)
- [Alex's slides (PDF)]({{site.url}}/assets/talks/2023/AlexArthur-OnmorninginasleepyGermanvillage.pdf)

#### Tony Mann: An amusing magic square
I will present an amusing magic square (at least, it amuses me)

- [Tony's slides (PPT)]({{site.url}}/assets/talks/2023/TonyMann-ACoolMagicSquare.pptx)
- [Tony's slides (PDF)]({{site.url}}/assets/talks/2023/TonyMann-ACoolMagicSquare.pdf)
...
- [Instruction manual for the E6-B flight computer](https://www.sportys.com/media/pdf/asae6b.pdf)
...
- [Miles's slides (online)](https://docs.google.com/presentation/d/1voJpLzhjQOT8AIRhABz5GgfxVtVc13FDkJ_Mu-L6t5Y/edit?usp=sharing)
...
- [More on the 'Friendly Floatees' Spill](https://en.wikipedia.org/wiki/Friendly_Floatees_spill)
...
- [Joey's slides (online)](https://docs.google.com/presentation/d/13lPSSgjFCubjqQVlpJUKXXLGAE30f37O2myu9FzKqmM/edit#slide=id.p)
...
- [Rotation With Three Shears - blog post by Tom Forsyth](https://cohost.org/tomforsyth/post/891823-rotation-with-three)
...
- [Matt's slides (online)](https://mattp.co/mj2023)
...
- [Pedro's slides (PPT)]({{site.url}}/assets/talks/2023/PedroFreitas-A19thCenturyLotterywithaDeckofCards.pptx)
- [Pedro's slides (PDF)]({{site.url}}/assets/talks/2023/PedroFreitas-A19thCenturyLotterywithaDeckofCards.pdf)
...
- [VisualPDE Simulation of the Heat Equation](https://visualpde.com/sim/?preset=heatEquation)
- [VisualPDE Simulation of a maze](https://visualpde.com/sim/?preset=maze)
- [VisualPDE Simulation of Alan Turing's face](https://visualpde.com/sim/?preset=Alan)
...
- [Hannah's slides (PPT)]({{site.url}}/assets/talks/2023/HannahGray-GenderintheGrooveAreHalfOurTunesToppedbyDudes.pptx)
- [Hannah's slides (PDF)]({{site.url}}/assets/talks/2023/HannahGray-GenderintheGrooveAreHalfOurTunesToppedbyDudes.pdf)

#### Colin Wright: The Moebius Rollercoaster
Some rollercoaster rides are described as "Moebius" ... where's the twist?

- [The Grand National Rollercoaster, on Wikipedia](https://en.wikipedia.org/wiki/Grand_National_(roller_coaster))
