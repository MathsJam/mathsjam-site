...
#### Pat Ashforth : Barbie Maths

How to persuade knitters and crocheters to use maths without knowing it

- [Pat's slides (PPT)]({{site.url}}/assets/talks/2019/PatAshforth-BarbieMaths.pptx)
...
#### David Mitchell : The Brothers Fibonacci; Etiam mingens mathematicae memini! (The Latin can be omitted from the title if exceeds max. letter count).

Shyness in the gents pointed Fibonacci to his celebrated discovery. The increasing obesity of clients leads to a generalisation of his sequence and of the algebraically expressible Golden Ratio to which the ratio of successive numbers converges. I have failed and challenge others to find a geometric interpretation of higher-order ratios. (Thanks to Nottingham MathsJam attendees for illuminating observations)

- [David's slides (PPT)]({{site.url}}/assets/talks/2019/DavidMitchell-TheBrothersFibonacci;Etiammingensmathematicaememini!(TheLatincanbeomittedfromthetitleifexceedsmax.lettercount)..pptx)
...
I recently came across this interesting variation of the "I will construct a magic square for a given target sum" trick, due to Andi Gladwin and published as "Magic Squared".

- [Tony's slides (PPT)]({{site.url}}/assets/talks/2019/TonyMann-Acuriousmagicsquaretrick.pptx)

#### Peter Rowlett : #tmwyk

Can I provide this if I actually write the talk? I'm not sure how much time to invest in planning out a talk I may not give?
...
1.  dimensional analysis with two examples, show that
 ...
 b/ the radius of flight of a boomerang is independent of how fast you throw it
I'd demonstrate the latter, not the former

2.  keeping water in a cup
Proving (graphically) that a cup full to the brim with water sitting on (not glued to) a plate on a string can be swung around your head in any fashion (not just in a vertical circle) without spilling a drop.
With live demo.

3.  Nodes of vibration of a bending beam
      with a beautiful - and musical - demo
    and how this helps if you have a noisy washing machine

4.  Proof that \int_0^\infty sin(x) dx = 1
           and \int_0^\infty cos(x) dx = 0
     done using simple A-level maths
           And why it matters!
...
This talk is a look at key mathematical events of the year, with a twist. 
...
- [Elaine's slides (PPT)]({{site.url}}/assets/talks/2019/Elaine-ChineseTake-Away!.pptx)
